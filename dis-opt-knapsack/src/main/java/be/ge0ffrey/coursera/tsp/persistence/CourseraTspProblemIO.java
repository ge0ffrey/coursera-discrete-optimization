...
public class CourseraTspProblemIO implements ProblemIO {

    public static final String FILE_EXTENSION = "txt";

    private CourseraTspImporter importer = new CourseraTspImporter();
    private CourseraTspExporter exporter = new CourseraTspExporter();
