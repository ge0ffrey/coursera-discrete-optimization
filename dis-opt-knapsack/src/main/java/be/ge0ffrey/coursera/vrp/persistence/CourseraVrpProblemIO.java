...
public class CourseraVrpProblemIO implements ProblemIO {

    public static final String FILE_EXTENSION = "txt";

    private CourseraVrpImporter importer = new CourseraVrpImporter();
    private CourseraVrpExporter exporter = new CourseraVrpExporter();
