...
public class CourseraVrpImporter extends AbstractTxtSolutionImporter {

    public static void main(String[] args) {
        new CourseraVrpImporter().convertAll();
    }

    public CourseraVrpImporter() {
        super(new CourseraVrpDao());
    }

    public CourseraVrpImporter(boolean withoutDao) {
        super(withoutDao);
    }

    @Override
    public String getInputFileSuffix() {
        return CourseraVrpProblemIO.FILE_EXTENSION;
    }

    public TxtInputBuilder createTxtInputBuilder() {
        return new CourseraVrpScheduleInputBuilder();
    }

    public static class CourseraVrpScheduleInputBuilder extends TxtInputBuilder {
