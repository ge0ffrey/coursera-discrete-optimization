...
public class KnapsackProblemIO implements ProblemIO {

    public static final String FILE_EXTENSION = "txt";

    private KnapsackImporter importer = new KnapsackImporter();
    private KnapsackExporter exporter = new KnapsackExporter();
